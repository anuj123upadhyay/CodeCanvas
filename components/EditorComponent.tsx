  ...
  return (
    <div className="min-h-screen dark:bg-slate-900 rounded-2xl shadow-2xl py-6 px-8">
      ...
      <div className="flex items-center justify-between pb-3">
        <h2 className="scroll-m-20  text-2xl font-semibold tracking-tight first:mt-0 text-purple-700 ">
          CodeCanvas
        </h2>
      ...
      {/* EDITOR  */}
      <div className="bg-slate-400 dark:bg-slate-950 p-2 py-3 rounded-2xl">
        <ResizablePanelGroup
